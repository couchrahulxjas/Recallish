...
import { reportRecallishError } from "../lib/recallish-error-reporting";
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  useEffect(() => {
    reportRecallishError(error, { boundary: "tanstack_root_error_component" });
  }, [error]);
  ...
  head: () => ({
    meta: [
      ...
      { title: "Recallish — One memory. Every assistant." },
      {
        name: "description",
        content:
          "Recallish is a local-first memory layer for AI assistants. Start with Claude, continue with Gemini — your context stays on your machine.",
      },
